  ...
  render() {
    ...
    return <div className="bountyPrice" style={{ width: "100%", display: "inline-block" }}>
      <div style={{ backgroundColor: "rgba(1, 1, 1, 0.05)", display: "block", overflow: "hidden", padding: "15px" }}>
        ...
        <h5 style={{ display: 'inline-block', marginTop: "7.5px", marginBottom: "0px", color: "#2D0874", fontSize: "32px", fontWeight: "600" }}>{state.value}<b style={{ color: "#f73859", fontWeight: "600", lineHeight: "28px" }}>{' '}{state.symbol ? state.symbol : 'ETH '}</b></h5>
      ...
      <form className='Contribute' onSubmit={handleContribute} style={{ width: "100%", display: "inline-block", marginTop: "30px" }}>
        ...
        <div style={{ backgroundColor: "#f73859" }}>
          <button type='submit' className='AddBtn' style={{ border: "0", backgroundColor: "#f73859", color: "rgb(25, 55, 83)" }}>Fund this project</button>
