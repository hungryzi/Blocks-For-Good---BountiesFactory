      ...
      web3.version.getNetwork((err, netId) => {
        if (netId === "1") {
          ...
          if (this.state.version == "v0") {
            this.setState({
              StandardBounties: web3.eth.contract(json.interfaces.StandardBounties).at(json.rinkeby.standardBountiesAddress.v0),
